          ...
          <Col md={7}>
            <Fade duration={3000}>
              <p className="home-about-body">
                My name is <b className="purple">Raja Shoaib </b> 
                  and I am a <b className="purple">Computer Science and Engineering </b> 
                    student at <b className="purple">Shri Ram Institute of Technology </b>
                      in Jabalpur, India.
                <br />
                <br />
                  ...
                  <b className="purple">
                    {" "}
                    C, C++, Core Java, HTML, CSS, MySql, and JavaScript.{" "}
                  </b>
                <br />
                <br />
